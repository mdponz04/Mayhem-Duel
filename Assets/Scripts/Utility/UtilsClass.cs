...
namespace CodeMonkey.Utils
{
    ...
    public static class UtilsClass
    {
        ...
        public static bool IsLayerInLayerMask(int gameObjectLayer, LayerMask layerMask)
        {
            return (layerMask & (1 << gameObjectLayer)) != 0;
        }

        public static TInterface GetInterfaceComponent<TInterface>(GameObject gameObject) where TInterface : class
        {
            TInterface neededComponent = gameObject.GetComponent<TInterface>();
            ...
            neededComponent = gameObject.GetComponentInParent<TInterface>();
            if (neededComponent != null)
            {
                return neededComponent;
            }
